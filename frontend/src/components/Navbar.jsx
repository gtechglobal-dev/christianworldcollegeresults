...
export default function Navbar() {
  ...
  const navLinks = user
    ...
    : [
        ...
        { label: 'Sign Up', to: '/signup', className: 'bg-yellow-600 hover:bg-yellow-700 px-4 py-1.5 rounded' }
      ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          <Link to="/" className="flex items-center space-x-3 shrink-0" onClick={() => setMenuOpen(false)}>
            <img src="/christian-world logo.png" alt="Christian-World College Koko" className="h-9 w-9 sm:h-10 sm:w-10 rounded-full object-cover" />
